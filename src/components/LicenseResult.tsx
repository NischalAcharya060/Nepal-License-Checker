...
export default function LicenseResult({ state, result, licenseNumber, onCheckAnother }: LicenseResultProps) {
  ...
  if (state === 'error') {
    return (
      <div className="overflow-hidden rounded-2xl border border-[var(--error-border)] bg-white shadow-sm">
        <div className="flex items-center gap-3 bg-gradient-to-r from-[var(--error)] to-[#e74c3c] px-4 py-5 sm:px-6">
          ...
          <div>
            ...
            <p className="text-sm text-white/85">Unable to reach DOTM records at this time.</p>
          </div>
        </div>
  ...
  if (state === 'not_found') {
    return (
      <div className="overflow-hidden rounded-2xl border border-[var(--border-default)] bg-white shadow-sm">
        <div className="flex items-center gap-3 bg-gradient-to-r from-[var(--error)] to-[#e74c3c] px-4 py-5 sm:px-6">
          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-white/20">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">Not Yet Printed</h2>
            <p className="text-sm text-white/85">Not found in current DOTM printed records.</p>
          </div>
        </div>
        ...
        <div className="space-y-4 p-4 sm:p-6">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-[var(--error-border)] bg-[var(--error-bg)] p-3.5 sm:col-span-2 sm:p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-[var(--error)]">Not in printed records</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 rounded-xl border border-[#c8d8f0] bg-[var(--nepal-blue-soft)] p-4">
            ...
            <p className="text-sm leading-6 text-[#2d5fa8]">
  ...
  if (state === 'found' && result) {
    return (
      <div className="overflow-hidden rounded-2xl border border-[var(--success-border)] bg-white shadow-sm">
        <div className="flex items-center gap-3 bg-gradient-to-r from-[var(--success)] to-[#14a366] px-4 py-5 sm:px-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">License Printed & Ready!</h2>
            <p className="text-sm text-white/90">Your smart card license has been printed.</p>
          </div>
        </div>
        ...
        <div className="space-y-4 p-4 sm:p-6">
          ...
          <div className="flex gap-3 rounded-xl border border-[#c8d8f0] bg-[var(--nepal-blue-soft)] p-4">
            ...
            <div>
              <p className="mb-1 text-sm font-bold text-[#2d5fa8]">
